...
- Recherche OpenStreetMap via Overpass sur les tags prioritaires `amenity=toilets`, `amenity=public_bath`, `toilets:public=yes`, ainsi que `highway=rest_area` et `amenity=sanitary_dump_station`.
